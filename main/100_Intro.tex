...
Chapter~\ref{bdoodle:chapter} introduces the Batched Doodle Problem which is motivated by a well-known tool for group scheduling, called ``Doodle''~\footenote{http://www.doodle.com/}. In the Batched Doodle Problem, we propose an algorithmic approach to group scheduling by optimizing 
