...
Chapter~\ref{} introduces the Batched Doodle problem which is motivated by a well-known tool called ``Doodle''~\footenote{http://www.doodle.com/}, which is a web-based 
