...
In this chapter, we will define and study the Probabilistic Matrix Inspection Problem, which models the essence of every real-life application we mentioned in this introduction. To focus on the model itself, we  
