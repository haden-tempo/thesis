...
In Section~\ref{matrix:sec:results}, we 
In this chapter, we define the Probabilistic Matrix Inspection Problem and present many technical results, focusing on algorithm design. 
