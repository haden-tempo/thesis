...
Given a random matrix whose entries are Bernoulli random variables, the objective is to find an optimal sequence of inspections (which is a permutation of the entries of the matrix). 
