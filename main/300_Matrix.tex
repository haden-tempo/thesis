...
We first consider two special cases of the Probabilistic Matrix Inspection problem when $n=1$ or $m=1$ (row vectors or column vectors), which admit intuitive, greedy algorithms. We then discuss a couple of interesting properties of an optimal inspection policy, which leads to our main result and algorithm.
