...
Batched Doodle generalizes Doodle by allowing columns-by-columns inspections, and we further generalize it by allowing entry-by-entry inspections. This generalization allows for more applications that are not necessarily motivated by group scheduling settings.
