...
While the motivation of the Probabilistic Matrix Inspection Problem comes from the group scheduling problem, there are many other applications that can be modeled in this manner. For instance, suppose that some research lab is trying to hire a new researcher out of some candidates. 
