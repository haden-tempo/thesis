...
Given several examples of how these problems can be modeled in the same manner, we will first define an abstract problem that underlies in all of the applicable scenarios we mentioned in this introduction.
We will then present our main technical results along with insights, followed by how our results can be applied to these scenarios. 
