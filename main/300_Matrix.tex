...
Given several examples of how these problems can be modeled in the same manner, we will focus on defining and investigating an abstract problem, the Probabilistic Matrix Inspection Problem, and 
