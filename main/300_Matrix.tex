...
Let us introduce mathematical notation we use in this chapter, and formally define the Probabilistic Matrix Inspection Problem, followed by an example to help the reader understand the setup.
