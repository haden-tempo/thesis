...
In such cases, the student can ask the advisor and exam chair to rule out datet/times on which one of them is unavailable, and then ask other examiners about their availability. 
