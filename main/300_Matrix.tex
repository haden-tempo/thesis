...
While the motivation of the Probabilistic Matrix Inspection Problem comes from the group scheduling problem, there are many other applications that can benefit from it. For instance, rows represent a set of requirements 
