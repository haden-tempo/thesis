...
While the motivation of the Probabilistic Matrix Inspection Problem comes from the group scheduling problem, there are many other applications that can be modeled in this manner. For instance, suppose that some research lab is trying to hire a new researcher and they are considering a number of candidates.



 out of some candidates. The lab requires that every member of the lab approve of the candidate to be hired; each member of the lab may have a rough estimate on the likelihood of him/her approving of a certain candidate, perhaps after reading the candidate's curricular vitae and research statement. Yet the outcome become certain only after a lab member interviews a candidate in person. In this simplified scenario of hiring a researcher, the research lab's goal is to hire a candidate that is approved by every member, yet the lab cannot afford to have every candidate to be interviewed by every member -- that would be time-consuming and often unnecessary. If a certain candidate is 
