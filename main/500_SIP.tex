...
These hardness results do not imply similar hardness results for \GSIPs for two reasons. 
First, the hardness results on anonymous hedonic games do not hold for \GSIP\ 
because \GSIPs is not equivalent to anonymous hedonic games. Second, one can 
transform an instance of \GSIPs into a (non-anonymous) hedonic game 
