...
%TODO 02: AAAI'15 appendix has a proof from max-2-sat. Too long?
aa

\paragraph{When $\alpha = 2$ and $\beta \geq 0$.}
%TODO 03: finding max is easy, but finding size k is not. 
bb
...
\paragraph{When $\alpha = 1$ and $\beta \geq 1$.} %TODO 05
b
c
b

\paragraph{When $\alpha = 2$ and $\beta \geq 0$.} %TODO 06
cd
a
af
e
