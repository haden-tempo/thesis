...
In summary, we have shown that there exists a polynomial time reduction from the Maximum-Independent-Set problem in cubic graphs to \GSIP\ while restricting to $(0,2)$-instances and seeking maximum individually rational invitations.  This proves that the decision problem of finding an IR invitation of size $k$ in $(0,2)$-instance of \GSIP\ is equivalent to the Max-Independent-Set problem. We conclude that $(0,2)$-\GSIP\ is NP-hard even if we seek IR invitations. 
