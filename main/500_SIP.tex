...
For each connected component, we determine whether it is possible to include exactly $x$ agents in our solution (where $x\in [0,k]$) such that those $x$ agents would satisfy stability conditions (provided that we choose $k-x$ agents from other components). 
