...
\end{theorem} 
\begin{proof}
	We reduce $k$-IR-Invitation to the weighted circuit SAT~\footnote{For details the WCSAT problem see the work by Creignou and Vollmer~\shortcite{creignou2015parameterized}.} of constant depth and of weft at most 1. 
