...
It is also worth noting that finding a maximum-size individually rational invitation is solvable in poly-time (see~\cite{LEE15AAAI}), but finding an IR invitation of a given size is NP-hard. 
