...
\end{theorem} 
\begin{proof}
We first reduce the Independent-Set problem (undirected) cubic graphs in which each node has a degree of three. Finding the maximum independent set in cubic graphs was shown to be NP-complete by Garey, et al.~\cite{Garey_Max_Is_Cubic}. 
