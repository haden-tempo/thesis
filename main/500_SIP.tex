...
Now consider agents $i\in N_A$ and $j\in N_C$ with $F_i = \{j\}$; we must include both agents in our solution or exclude both agens in our solution to satsify stability. Therefore, we can change the instance 
