...
All agents in $N_B$ do not approve size $k$ but they approve size $k+1$, and therefore we must ensure that friends of agents in $N_B$ must also be not invited. If there is some agent $i\in N_B$ with $F_i = \emptyset$, we 
