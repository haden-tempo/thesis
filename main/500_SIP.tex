...
\end{theorem}
\begin{proof}
	The main idea is similar to that of our proof of Theorem~\ref{thm:IR_invitation_FPT}. 
...
\begin{proof}
	...
	This shows W[1]-hardness, and W[1]-completenes follows from Theorem~\ref{thm:stable_W2}. 
...
\begin{proof}
	...
	This shows W[2]-hardness, and W[2]-completenes follows from Theorem~\ref{thm:stable_W2}.
\end{proof}
