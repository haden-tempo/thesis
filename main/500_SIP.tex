...
It is worth noting that finding a maximum size IR invitation can be solved in polynomial time when $\beta = 0$; this statement does not contradict Theorem~\ref{SIP:thm:IR_invitation_NPC}. While finding a maximum size IR invitation is easy, finding an IR invitation of size $k$ is 
