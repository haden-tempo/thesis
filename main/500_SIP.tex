...
invitations. Ballester~\cite{NP_hedonic} provides a number of computational complexity results (in fact, NP-hardness results) for finding a core-stable, Nash-stable, or individually rational outcome in hedonic games and anonymous hedonic games. However, these hardness results do not imply similar hardness results for \SIP. Hardness results on anonymous hedonic games , because agents no longer have anonymous preferences in \SIP. 
