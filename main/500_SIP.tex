...
\begin{proof} %TODO 02
	...
	It is easy to verify that finding an independent set in the original cubic graph is equivalent to finding an IR invitation of the same size in our instsance. To prove for the case where $\alpha=0$ and $\beta=2$, we need to modify our reduction because each agent can only have two other agents in their rejection set. 
