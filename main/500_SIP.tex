...
Despite the fact that the majority of the problems we consider in this work are NP-hard and that the two problems belong to the same class under classical complexity, we showed that 

many special cases of the problem admit efficient FPT algorithms.
