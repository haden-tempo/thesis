...
From the work by Darmann et al.~\cite{GASP12WINE}, we know that if all agents have anonymous preferences, then \SIPs can be solved in polynomial time -- which is equivalent to \GASPs with one activity. 
