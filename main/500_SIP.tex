...
These hardness results do not imply similar hardness results for \SIPs for two reasons. 
First, the hardness results on anonymous hedonic games do not hold for \SIPs because \SIPs is not equivalent to anonymous hedonic games. Second, one can 
transform an instance of \SIPs into a (non-anonymous) hedonic game 
