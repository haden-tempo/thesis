...
\end{theorem}
As corollaries, the following four problems are also NP-hard under any of the three restrictions mentioned in Theorem~\ref{GASP:thm:nphard}. Note that the first three problems parameterize the size of an assignment while the last problem parameterizes the number of used activities in a perfect assignment.
\begin{itemize}
