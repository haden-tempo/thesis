...
Lastly, Darmann~\cite{DARMANN15ADT} considered a different setting of \GASPs where agents are assumed to have strict, ordinal preferences over the outcomes, whereas both our work and the work of Darmann et al.~\cite{GASP12WINE} assumes that agents have a dichotomic preference over outcomes (an outcome is either approve or not approved). It is an interesting future problem to consider how our results in this work can be extended to the ordinal setting.
