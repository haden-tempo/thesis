...
In Chapters~\ref{bdoodle:chapter,matrix:chapter} we considered settings where an event organizer is trying to choose a date/time option at minimal cost for a group of agents given their likelihood of availability.
