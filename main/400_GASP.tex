...
If there is some activity $a_{j'}$ of some other color $d'$ with threshold $u_i(a_{j'}) \geq k_{d'} + 1$, then we must reject the coloring because choosing $a_{j'}$ for color $d'$ would violate stability
