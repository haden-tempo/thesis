...
\begin{proof} 
	...
	Let us reduce $k$-Stable-GASP with increasing preferences to the $k$-Clique problem, which shows that $k$-Stable-GASP is in $W[1]$. 
...
\begin{proof} % k-EF-GASP is W[1]-hard.
	...
	\paragraph{Proof of completeness.} %TODO
	To show completeness, one can reduce $k$-EF-GASP to the colored $k$-clique problem which is known to be W[1]-complete (we omit the details).
\end{proof}
