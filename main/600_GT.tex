...
If a mechanism chooses $\pi_1$ given $(P_1, P_2)$, then agent $2$ has an incentive to lie about her preferences by reporting $\hat{P}_2: (a_2, 2) \succ_2 (a_2, 1)$ instead (by not approving $(a_1, 2)$). 
o achieve $\pi_2$. 
