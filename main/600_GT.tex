...
In this chapter, we focus on the intersection of the Group Activity Selection Problem and the Stable Invitations Problem, which is the least complex problem in computational sense, to investigate how strategic behavior of agents can affect the outcome. 
