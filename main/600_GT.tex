...
TODO: To related this to IR.

%TODO: Also include anecdnote from Matt Jackson.


Recall that \AOIPs is a special case of \GASPs and \SIPs as there is only one activity and no friends or enemies in \AOIPs instances. As such, our impossibility results are applicable to \GASPs and \SIPs if ordinal preferences of agents are assumed. 

Let us now consider difference special cases of the Group Activity Selection Problem (\GASP) and the Stable Invitations Problem (\SIP). Our impossibility results hold for both problems because \AOIPs is a special case of these two problems, respectively.
However, we present a couple of impossibility results of \GASPs and \SIPs by considering different special cases of these problems.

TODO: Impossibility with inc and two activities in gasp.
...
TODO: Impossibility with just friends, no enemies, all sizes approved.
n = 2.

TODO: Impossibility with just enemies, no friends, all sizes approved and equally preferred.
n = 2.
E1 = 2, E2 = 1.
I1 = 1, I2 = 2. 
If I1 is picked, then a2 can report E2 = empty. This makes I1 not stable. 
