...
The induced preference over these three assignments can be determined from each agent's preference: 
	...
	\end{equation*}
If a mechanism chooses $\pi_1$ given $(P_1, P_2)$, then agent $2$ has an incentive to lie about her preferences to achieve $\pi_2$. By symmetry, a mechanism cannot choose $\pi_2$, either. 
