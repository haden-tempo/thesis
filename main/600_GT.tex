...
\begin{definition}\label{def:preferenceTypes}
...
\end{definition}
We assume that agents can have arbitrary preferences, but these two special types  preferences play an important role in the strategic case in Section~\ref{sec:Mechanism}. 
