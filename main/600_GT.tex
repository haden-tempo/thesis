...
Consider the two agents with identical preferences from the example:
	...
	Let $\mathcal{M}$ be any (deterministic) mechanism.
	If 
		
	 If $I_1$ were to be chosen by the organizer, $a_2$ would have an incentive to act strategically, by reporting $\hat{P}_2 (1 \succ 2 \succ 0)$ instead of $P_2$. 
