...
Given an instance of \ASIP, we define $V_i$ (the set of available actions to $a_i$) to be the set of all preferences over $X$ where $X = \{0, 1, 2, \dots, n\}$ is the set of outcomes.\footnote{In the Anonymous Stable Invitations Problem, invitations of the same size are indistinguishable } 
