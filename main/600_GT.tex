...
\begin{definition}
	The Anonymous Ordinal Invitations Problem (\AOIP) is a special case of the Stable Invitations Problem (and of the Group Activity Selection Problem), in which no agent has friends or enemies. An instance of \ASIPs is given by a set of agents $N = \{a_1, a_2, \dots, a_n\}$ and an approval set $S_i$ for each agent.
\end{definition}
