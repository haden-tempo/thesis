...
In this chapter we investigate how strategic behavior of agents can affect the outcome in the Group Activity Selection Problem and the Stable Invitations Problem that we presented in previous two chapters. 
