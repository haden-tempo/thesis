...
To understand why strategic behavior of agents can be troublesome, we investigate the Stable Invitation Problem with minor modifications: We assume that agents have no friends or enemies while agents have total preorder over sizes of invitations instead of an approval set. Assuming ordinal preferences 
