...
Let us now generalize our impossibility results to the Group Activity Selection Problem (\GASP) and the Stable Invitations Problem (\SIP). 
Because the Anonymous Ordinal Invitations Problem (\AOIP) is a speical case of \GASP, our impossibility results from Theorem~\ref{thm:impossibility} still hold.
