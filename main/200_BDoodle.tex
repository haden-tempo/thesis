...
\Times spent by the scheduling process is measured by the number of iterations and \Inconveniences caused is measured by the number of options that have been sent out by the organizer. In the random matrix model, an inspection of a group of columns reveals 
