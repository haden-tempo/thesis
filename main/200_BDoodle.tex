...
\subsection{Optimal Algorithm} \label{bdoodle:sec:Algorithm}
	...
	Algorithm~\ref{bdoodle:alg:recursive} runs in polynomial time, and returns an optimal B-Doodle mechanism that minimizes the expected cost, given an instance $(N, S, f, c, P)$ of \BDP\ when $c$ is $\theta$-simple.
	\end{theorem}
	\begin{proof}
