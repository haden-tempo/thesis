...
\subsection{Preliminaries}
	...
	Therefore we can focus on the following sub-class of \emph{simplified} B-Doodle mechanisms when we seek an optimal B-Doodle mechanism in the rest of this chapter.
