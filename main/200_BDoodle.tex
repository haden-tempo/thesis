...
\end{tabular}
\caption{Critical point $S^*$ for various values of $(n, p)$ are shown when $f = 1, \alpha = 2$. Entries in boldface emphasize that $S^* \leq 15$.} \label{bdoodle:table:DoodleSuboptimal}
\end{table}
...
\end{tabular}
\caption{Efficiency of Doodle $e_{D}$ for values of various $(n, p)$ when $f = 1, \alpha=2, s = 15$.
